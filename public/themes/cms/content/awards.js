...
function crudAwards() {
    ...
    var controller = new Vue({
        ...
        methods: {
            ...
            fetchData: function(){
                var domain  = laroute.url('/cms/awards/data', []);
            ...
            storeData: function(event){
                ...
                var domain = laroute.url('/cms/awards/store-banner', []);
            ...
            editBanner: function (id) {
                ...
                var domain = laroute.url('/cms/awards/edit-banner', []);
            ...
            editData: function (id) {
                ...
                var domain = laroute.url('/cms/awards/edit', []);
                this.$http.post(domain, form).then(function(response) {
                    response = response.data
                    if (response.status) {
                        this.models = response.data;
            ...
            changeStatusBanner: function(id) {
                ...
                var domain = laroute.url('/cms/awards/change-status-banner', []);
                this.$http.post(domain, form).then(function(response) {
                    response = response.data
                    if (response.status == false) {
                        this.fetchData()
            ...
            changeStatus: function(id) {
                ...
                var domain = laroute.url('/cms/awards/change-status', []);
                this.$http.post(domain, form).then(function(response) {
                    response = response.data
                    if (response.status == false) {
                        this.fetchData()
            ...
            deleteDataBanner: function(id) {
                ...
                var domain = laroute.url('/cms/awards/delete-banner', []);
                var form = new FormData();
            ...
            deleteData: function(id) {
                ...
                var domain = laroute.url('/cms/awards/delete', []);
                var form = new FormData();
            ...
            reorder: function(oldIndex, newIndex) {
                ...
                var domain  = laroute.url('/cms/awards/order', []);
            ...
            reorderBanner: function(oldIndex, newIndex) {
                ...
                var domain  = laroute.url('/cms/awards/order-banner', []);
