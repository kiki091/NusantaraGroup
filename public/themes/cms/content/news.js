    ...
    var controller = new Vue({
        ...
        methods: {
            ...
            removeImageSliderFromServer: function (id, index) {
                ...
                var domain = '/news/delete-image-slider';
            ...
            fetchData: function(){
                this.$http.get('/news/data', []).then(function (response) {
            ...
            editData: function (id) {
                ...
                this.$http.post('/news/edit', form).then(function(response) {
                    response = response.data
                    if (response.status) {
                        this.models = response.data
                        this.thumbnail = response.data.thumbnail_url

                        this.form_add_title = "Edit News"
                        $('.btn__add').click()
            ...
            editImageSlider: function (id) {
                ...
                this.$http.post(domain, form).then(function(response) {
                    ...
                    if (response.status) {
                        ...
                        this.images_detail_edit = response.data.images_detail
            ...
            postEditImageSlider: function(event) {
                ...
                $("#FormNewsImageSliderForm").ajaxForm(optForm);
                $("#FormNewsImageSliderForm").submit();
            },
            ...
            resetForm: function(){
                ...
                this.images_detail_edit = {0: '', 1:'', 2:'', 3: ''};
                this.default_total_detail_image = [0];
                this.total_detail_image = [0];
                this.edit = false

                this.form_add_title = "News"

                document.getElementById("FormNews");
