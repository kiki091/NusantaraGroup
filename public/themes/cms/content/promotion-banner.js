...
function crudBannerPromotions() {
    ...
    var controller = new Vue({
        ...
        methods: {
            ...
            fetchData: function(){
                this.$http.get('/promotions/banner/data', []).then(function (response) {
            ...
            editBanner: function (id) {
                ...
                this.$http.post('/promotions/banner/edit', form).then(function(response) {
            ...
            changeStatusBanner: function(id) {
                ...
                var domain = '/promotions/banner/change-status';
            ...
            deleteDataBanner: function(id) {
                ...
                var domain = '/promotions/banner/delete';
                var form = new FormData();
            ...
            reorderBanner: function(oldIndex, newIndex) {
                ...
                var domain  = '/promotions/banner/order';
