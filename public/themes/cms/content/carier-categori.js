...
function crudCarierCategori() {
    ...
    var controller = new Vue({
        ...
        data: {
            ...
            form_add_title: "Carier",
            sectionDelete : 'categori',
            id: '',
            edit: false,
            responseData: {},
        },
        ...
        methods: {
            ...
            fetchData: function(){
                this.$http.get('/carier/data', []).then(function (response) {
            ...
            storeData: function(event){
                ...
                $("#FormBannerCarier").ajaxForm(optForm);
                $("#FormBannerCarier").submit();
            },

            storeCarier: function(event){
            ...
            editBanner: function (id) {
                ...
                this.$http.post('/carier/edit-banner', form).then(function(response) {
            ...
            editData: function (id) {
                ...
                this.$http.post('/carier/edit', form).then(function(response) {
                    response = response.data
                    if (response.status) {
                        this.models = response.data
                        this.thumbnail = response.data.thumbnail_url

                        this.form_add_title = "Edit Carier Category"
            ...
            changeStatusBanner: function(id) {
                ...
                var domain = '/carier/change-status-banner';
            ...
            changeStatus: function(id) {
                ...
                var domain = '/carier/change-status';
                this.$http.post(domain, form).then(function(response) {
                    response = response.data
                    if (response.status == false) {
                        this.fetchData()
            ...
            deleteDataBanner: function(id) {
                ...
                var domain = '/carier/delete-banner';
                var form = new FormData();
            ...
            reorderBanner: function(oldIndex, newIndex) {
                ...
                var domain  = '/carier/order-banner';
