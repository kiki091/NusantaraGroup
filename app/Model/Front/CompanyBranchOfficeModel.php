...
class CompanyBranchOfficeModel extends Model
{
    ...
    {
        return $this->hasMany('App\Model\Front\CompanyBranchOfficeModelTrans', 'branch_office_id', 'id');
    }

    public function translation()
    {
        return $this->belongsTo('App\Model\Front\CompanyBranchOfficeModelTrans', 'id', 'branch_office_id');
    }
