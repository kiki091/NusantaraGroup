...
class Promotion extends BaseImplementation implements PromotionInterface
{
    ...
    function __construct(PromotionModel $promotion, PromotionDatailModels $promotionDatail, PromotionGalleryModels $promotionGallery, PromotionImagesModels $promotionImages, PromotionTransModels $promotionTrans, PromotionTransformation $promotionTransformation)
    {
    ...
    */
    ...
    public function edit($data)
    {
        ...
        $singlePromotionData = $this->promotion($params, 'asc', 'array', true);

        return $this->setResponse(trans('message.cms_success_get_data'), true, $this->promotionTransformation->getSinglePromotionCmsTransform($singlePromotionData));
    }
