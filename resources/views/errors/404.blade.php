    ...
    <body>
                        ...
                        <div class="row" id="error-page">
                            <div class="col-sm-12">
                                <div class="box">
                                    ...
                                    <p class="buttons"><a href="{{route('homePage')}}" class="btn btn-primary"><i class="fa fa-home"></i> Go to Homepage</a>
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <script>
            function initialize() {
                var mapOptions = {
                    zoom: 15,
                    center: new google.maps.LatLng(-6.170164, 106.816069),
                ...
                var myLatLng = new google.maps.LatLng(-6.170164, 106.816069);
