...
<div style="display: none" id="template-box-wrapper-left">
	@include('Cms.content-template.pages.static-page.box-wrapper-left')
</div>
<div style="display: none" id="template-box-wrapper-center">
	@include('Cms.content-template.pages.static-page.box-wrapper-center')
</div>
<div style="display: none" id="template-box-wrapper-right">
	@include('Cms.content-template.pages.static-page.box-wrapper-right')
</div>