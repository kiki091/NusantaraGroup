                    ...
                    <div id="footer-content-js">
                        <div class="desktop-footer-block footer-block-03">
                            <div id="desktop-footer-mailing-list">
                                ...
                                <form action="{{ route('subscribeMail') }}" id="desktop-footer-mailing-list-form" method="post" class="simple-form-check" @submit.prevent>
                                    ...
                                    <input type="submit" value=">" @click="storeSubscribe">
                                </form><!-- form -->
                            </div>
