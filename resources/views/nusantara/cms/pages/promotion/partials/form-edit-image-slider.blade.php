<form action="{{ route('PromotionEditImageSlider') }}" method="POST" id="PromotionFormEditImageSliderForm" enctype="multipart/form-data" @submit.prevent>
								...
								<div class="form__photo__uploader__wrapper flex flex-align-center">
									<ul class="form__photo__uploader__ul photo-sortable" id="sort_images_slider" v-sort>
										...
										<li class="form__photo__uploader__li sort-item-images-slider" v-for="detailImage in total_detail_image">
											...
											<a href="javascript:void(0);" class="form__photo__remove__server" @click="removeImageSliderFromServer(gallery_edit[detailImage].id, detailImage)">&times;</a>
										</li>
									...
									<a href="javascript:void(0);" class="form__photo__placeholder" id="add-card-photo-uploader-en" @click="addMoreImageSlider" v-if="default_total_detail_image.length + total_detail_image.length != 8"><i>&plus;</i><span>Add New</span></a>
								</div>
