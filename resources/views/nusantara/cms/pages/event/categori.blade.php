    ...
    @include('nusantara.cms.include.page-title')
        <div class="row">
	        <div class="col-md-12 col-sm-12 col-xs-12">
	        	...
	        	@include('nusantara.cms.pages.event.partials.form')
		        ...
		        <div class="main__content__layer" style="margin-top: 5%;">
		        	<div class="content__top flex-between">
		        		...
		        		<div class="content__btn">
		        			<a href="#" class="btn__add" id="toggle-form" @click="resetForm">Add Category</a>
		        		</div>
		        	</div>
		        	<div class="content__bottom">
						<ul class="news__list sortable" id="sort" v-sort>
							<li class="news__list__wrapper sort-item" v-for="category in responseData.event_category" data-id="@{{ category.id }}">
										...
										<div class="news__list__detail__middle">
											<div class="news__list__desc">
												<div class="news__name">
													<a href="#" class="title__name content__edit__hover" @click="editData(category.id)">@{{ category.name }}</a>
												</div>
											</div>
										</div>
