<form action="{{ route('EventCategoriStoreData') }}" method="POST" id="FormEventCategori" enctype="multipart/form-data" files="true" @submit.prevent>
						...
						<div id="form-accordion">
							<div class="create__form__row">
								<div class="new__form__field">
									...
									<div class="field__icon">
										<input v-model="models.name" name="name" type="text" id="name" class="form-control" placeholder="Enter the name here">
									</div>
									<div class="form--error--message" id="form--error--message--name"></div>
								</div>
							</div>
							...
							<div class="create__form__row">
								<div class="new__form__field">
									<label>Slug</label>
									<div class="field__icon">
										<input v-model="models.name | lowercase | strSlug" name="slug" type="text" id="slug" class="form-control" placeholder="Enter the slug name here" readonly>
									</div>
