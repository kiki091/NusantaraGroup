    ...
    @include('nusantara.cms.include.page-title')
        <div class="row">
	        <div class="col-md-12 col-sm-12 col-xs-12">
	        	...
	        	@include('nusantara.cms.pages.news.partials.form')
	        	@include('nusantara.cms.pages.news.partials.form-edit-image-slider')
		        ...
		        <div class="main__content__layer" style="margin-top: 5%;">
		        	<div class="content__top flex-between">
		        		...
		        		<div class="content__btn">
		        			<a href="#" class="btn__add" id="toggle-form" @click="resetForm">Add News</a>
		        		</div>
		        	</div>
								...
								<div class="news__list__detail">
									...
									<div class="news__list__detail__middle-right">
										<div class="news__list__detail__middle">
											<div class="news__list__desc">
												<div class="news__name">
													<a href="#" class="title__name content__edit__hover" @click="editData(news.id)">@{{ news.title }}</a>
												</div>
											</div>
										</div>
										<div class="news__list__detail__right">
											...
											<a href="#edit-image-slider" class="btn__action__list" @click="editImageSlider(news.id)">
												<i class="ico-photo-edit flex">@include('nusantara.cms.svg-logo.ico-photo-edit')</i>
											</a>
											<a href="#delete-data" class="btn__delete" @click="showDeleteModal(news.id)">
