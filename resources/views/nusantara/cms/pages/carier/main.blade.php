    ...
    @include('nusantara.cms.include.page-title')
        <div class="row">
	        <div class="col-md-12 col-sm-12 col-xs-12">
								...
								<div class="alert__message__wrapper">
									...
									<div class="alert__message__btn">
										<div class="new__form__btn">
											...
											<a href="#" class="btn__form__create" @click="deleteData(delete_payload.id)" v-if="this.sectionDelete == 'categori'">Confirm</a>
				...
				@include('nusantara.cms.pages.carier.partials.form')
				@include('nusantara.cms.pages.carier.partials.form-banner')
		        ...
		        <div class="main__content__layer" style="margin-top: 5%;">
		        	<div class="content__top flex-between">
		        		...
		        		<div class="content__btn">
		        			<a href="#" class="btn__add btn_add_category" id="toggle-form-categori" @click="resetForm">Add Categori</a>
		        		</div>
		        	</div>
		        	<div class="content__bottom">
						<ul class="news__list sortable" id="sort" v-sort>
							<li class="news__list__wrapper sort-item" v-for="categori in responseData.carier_categori" data-id="@{{ categori.id }}">
								<div class="news__list__detail">
									<div class="drag__control">
										<div class="handle">
											@include('nusantara.cms.svg-logo.handle-drag')
									...
									<div class="news__list__detail__left">
										<img :src="categori.thumbnail_url">
									</div>
									<div class="news__list__detail__middle-right">
										<div class="news__list__detail__middle">
											<div class="news__list__desc">
												<div class="news__name">
													<a href="#edit-data" class="title__name content__edit__hover" title="Edit Data" @click="editData(categori.id)">@{{ categori.category_name }}</a>
												</div>
											</div>
										</div>
										<div class="news__list__detail__right">
											<label class="switch">
												<input class="switch-input" id="check_1" type="checkbox" :checked="categori.is_active == true" @change="changeStatus(categori.id)"/>
                                            	<span class="switch-label" data-on="Active" data-off="Inactive"></span> <span class="switch-handle"></span>
											</label>
											{{--
											<a href="#delete-data" class="btn__delete" @click="showDeleteModal(categori.id,'categori')">
												<i class="ico-delete">@include('nusantara.cms.svg-logo.ico-delete')</i>
											</a>
											--}}
										</div>
